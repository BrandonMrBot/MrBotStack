"""
This file declares the PCA interfaces available in {{ cookiecutter.project_name }} and their methods.
"""
...
class IRoutes(Interface):
    ...
    def before_mapping(self, config):
        """
        Called before the mapping of routes made by {{ cookiecutter.project_name }}.
    ...
    def after_mapping(self, config):
        """
        Called after the mapping of routes made by {{ cookiecutter.project_name }}.
...
class IAPIRoutes(Interface):
    ...
    def before_mapping(self, config):
        """
        Called before the mapping of API routes made by {{ cookiecutter.project_name }}.
    ...
    def after_mapping(self, config):
        """
        Called after the mapping of API routes made by {{ cookiecutter.project_name }}.
...
class IConfig(Interface):
    ...
    def update_config(self, config):
        """
        Called by {{ cookiecutter.project_name }} during the initialization of the environment
...
class IResource(Interface):
    ...
    def add_libraries(self, config):
        """
        Called by {{ cookiecutter.project_name }} so plugins can add new JS and CSS libraries to {{ cookiecutter.project_name }}
    ...
    def add_js_resources(self, config):
        """
        Called by {{ cookiecutter.project_name }} so plugins can add new JS Resources
    ...
    def add_css_resources(self, config):
        """
        Called by {{ cookiecutter.project_name }} so plugins can add new FanStatic CSS Resources
...
class ISchema(Interface):
    ...
    add new fields to {{ cookiecutter.project_name }} tables without affecting the structure
    of the database. New fields are stored in extra as JSON keys
    """

    def update_schema(self, config):
        """
        Called by {{ cookiecutter.project_name }} so plugins can add new fields to table schemata
...
class IDatabase(Interface):
    ...
    def update_orm(self, metadata):
        ...
        :param metadata: {{ cookiecutter.project_name }} ORM metadata object
...
class IRegistration(Interface):
    ...
    def before_register(self, request, registrant):
        """
        Called by {{ cookiecutter.project_name }} so plugins can do something before registering a user
    ...
    def after_register(self, request, registrant):
        """
        Called by {{ cookiecutter.project_name }} so plugins do something after registering a user

        :param request: ``pyramid.request`` object
        :param registrant: Dictionary containing the details of the registrant
        :return Return the next page that will be loaded after the registration. If empty or None the the {{ cookiecutter.project_name }}
...
class IUserAuthentication(Interface):
    ...
    def after_login(self, request, user):
        """
        Called by {{ cookiecutter.project_name }} so plugins can modify the login of users
    ...
    def on_authenticate_user(self, request, user_id, user_is_email):
        """
        Called by {{ cookiecutter.project_name }} so plugins can modify the way {{ cookiecutter.project_name }} gather information about the user
    ...
    def on_authenticate_password(self, request, user_id, password):
        ...
        :param request: ``pyramid.request`` object
        :param user_id: The user ID trying to authenticate
        :param password: The password as is typed in the {{ cookiecutter.project_name }} interface
...
class IUserAuthorization(Interface):
    ...
    def before_check_authorization(self, request):
        """
        Called by {{ cookiecutter.project_name }} so plugins can modify the normal authorization of users

        :param request: ``pyramid.request`` object
        :return Return true or false if {{ cookiecutter.project_name }} should check the authorization of a user.
    ...
    def custom_authorization(self, request):
        """
        Called by {{ cookiecutter.project_name }} so plugins can perform their own way of authorizing a user.
        :param request:
...
class IPublicView(Interface):
    """
    Allows to hook into {{ cookiecutter.project_name }}'s view public class.
    """

    def before_processing(self, request):
        """
        Called by {{ cookiecutter.project_name }}'s PublicView class before processing a public view
        :param request: Pyramid request object
        :return: None
        """
        raise NotImplementedError(
    ...
    def after_processing(self, request, context):
        """
        Called by {{ cookiecutter.project_name }}'s PublicView class after processing a public view but just before returning the context
        :param request: Pyramid request object
...
class IPrivateView(Interface):
    """
    Allows to hook into {{ cookiecutter.project_name }}'s private class.
    """

    def before_processing(self, request, class_data):
        """
        Called by {{ cookiecutter.project_name }}'s PrivateView class before processing a private view
        :param request: Pyramid request object
...
class ITranslation(Interface):
    ...
    def get_translation_directory(self):
        """
        Called by {{ cookiecutter.project_name }} so plugins can add a translation directory
    ...
    def get_translation_domain(self):
        """
        Called by {{ cookiecutter.project_name }} so plugins can add a translation domain
...
class ILogOut(Interface):
    """
    Allow extensions to hook to the {{ cookiecutter.project_name }} logout process
    """

    def before_log_out(self, request, user):
        """
        Called by {{ cookiecutter.project_name }} so plugins can perform actions before {{ cookiecutter.project_name }} logs out an user
        :param request: Pyramid request object
    ...
    def after_log_out(self, request, user):
        """
        Called by {{ cookiecutter.project_name }} so plugins can perform actions after {{ cookiecutter.project_name }} logs out an user
        :param request: Pyramid request object
...
class IUser(Interface):
    ...
    def before_create(self, request, user_data):
        """
        Called by {{ cookiecutter.project_name }} so plugins can perform actions before adding an user
        :param request: ``pyramid.request`` object
    ...
    def before_edit(self, request, user, user_data):
        """
        Called by {{ cookiecutter.project_name }} so plugins can perform actions before editing an assistant
        :param request: ``pyramid.request`` object
    ...
    def after_edit(self, request, user, user_data):
        """
        Called by {{ cookiecutter.project_name }} so plugins can perform actions before editing an user
        :param request: ``pyramid.request`` object
        :param user: User owner of the project
        :param user_data: User information
        :return: None
...
class IEnvironment(Interface):
    """
    Allows to hook into the process that creates the {{ cookiecutter.project_name }} environment
    """

    def after_environment_load(self, settings):
        """
        Called by {{ cookiecutter.project_name }} after the environment is configured
        :param settings: {{ cookiecutter.project_name }} settings
        """
