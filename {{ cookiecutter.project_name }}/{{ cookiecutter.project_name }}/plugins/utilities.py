...
import inspect
import os
from {{ cookiecutter.project_name }}.views.classes import PublicView, PrivateView
...
__all__ = [
    ...
    "{{ cookiecutter.project_name }}PublicView",
    "{{ cookiecutter.project_name }}PrivateView",
...
class {{ cookiecutter.project_name }}PublicView(PublicView):
    """
...
class {{ cookiecutter.project_name }}PrivateView(PrivateView):
    """
