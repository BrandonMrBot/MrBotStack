...
import {{ cookiecutter.project_name }}.config.jinja_extensions as je

jinja_extensions = """
                    jinja2.ext.do,jinja2.ext.i18n,                    
                    {{ cookiecutter.project_name }}.config.jinja_extensions:JSResourceExtension,
                    {{ cookiecutter.project_name }}.config.jinja_extensions:CSSResourceExtension,
                    {{ cookiecutter.project_name }}.config.jinja_extensions:ExtendThis,
                   """
...
def extract_{{ cookiecutter.project_name }}(fileobj, *args, **kw):
