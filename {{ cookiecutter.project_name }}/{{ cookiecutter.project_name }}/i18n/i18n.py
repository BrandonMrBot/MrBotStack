...
def add_localizer(event):
    ...
    module = sys.modules["{{ cookiecutter.project_name }}"]
    {{ cookiecutter.project_name }}_locale_path = os.path.join(os.path.dirname(module.__file__), "locale")
    list_of_desired_locales = [request.locale_name]
    translations = Translations.load(
        {{ cookiecutter.project_name }}_locale_path, list_of_desired_locales, "{{ cookiecutter.project_name }}"
    )
